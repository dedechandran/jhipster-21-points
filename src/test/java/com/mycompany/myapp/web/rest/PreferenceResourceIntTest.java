...
public class PreferenceResourceIntTest {
     ...
     *
     * @see com.mycompany.myapp.repository.search.PreferenceSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void setup() {
        ...
        final PreferenceResource preferenceResource = new PreferenceResource(preferenceRepository, mockPreferenceSearchRepository, userRepository);
