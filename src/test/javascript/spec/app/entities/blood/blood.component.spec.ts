...
import { BloodComponent } from 'app/entities/blood/blood.component';
import { BloodService } from 'app/entities/blood/blood.service';
import { Blood } from 'app/shared/model/blood.model';

describe('Component Tests', () => {
    describe('Blood Management Component', () => {
        let comp: BloodComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BloodComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.blood[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
