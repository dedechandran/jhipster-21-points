...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            cm.createCache(com.mycompany.myapp.domain.Weight.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Blood.class.getName(), jcacheConfiguration);
            cm.createCache(com.mycompany.myapp.domain.Preference.class.getName(), jcacheConfiguration);
